	...
	},
	{
		...
		children: [{
			...
			},
			{
				...
				name: 'receipt',
				component: resolve => {
					require(['@/views/order/receipt'], resolve)
				},
			},
			{
			...
			},
			{
				...
				name: 'returnGoods',
				component: resolve => {
					require(['@/views/order/returnGoods'], resolve)
				},
			},
			{
				...
				name: 'refund',
				component: resolve => {
					require(['@/views/order/refund'], resolve)
				},
			},
			{
				...
				name: 'returnCause',
				component: resolve => {
					require(['@/views/order/returnCause'], resolve)
				},
			},
			{
				...
				name: 'address',
				component: resolve => {
					require(['@/views/order/address'], resolve)
				},
			},
			{
				...
				name: 'addAddress',
				component: resolve => {
					require(['@/views/order/addAddress'], resolve)
				},
			},
			{
			...
			},
			{
				...
				name: 'addHeader',
				component: resolve => {
					require(['@/views/promotion/addHeader'], resolve)
				},
			},
			{
				...
				name: 'promotionList',
				component: resolve => {
					require(['@/views/promotion/list'], resolve)
				},
			},
			{
				...
				name: 'addGoods',
				component: resolve => {
					require(['@/views/promotion/addGoods'], resolve)
				},
			},
			{
				...
				name: 'groupList',
				component: resolve => {
					require(['@/views/promotion/groupList'], resolve)
				},
			},
			{
				...
				name: 'groupOrder',
				component: resolve => {
					require(['@/views/promotion/groupOrder'], resolve)
				},
			},
			{
				path: "/stock/in", //商品入库
				name: 'stockIn',
				component: resolve => {
					require(['@/views/stock/stockIn'], resolve)
				},
			},
			{
				path: "/stock/out", //商品出库
				name: 'stockOut',
				component: resolve => {
					require(['@/views/stock/stockOut'], resolve)
				},
			},
			{
				path: "/user/list", //用户列表
			...
			},
			{
				...
				name: 'advertising',
				component: resolve => {
					require(['@/views/operate/advertising'], resolve)
				},
			},
			{
				...
				name: 'addAdvertising',
				component: resolve => {
					require(['@/views/operate/addAdvertising'], resolve)
				},
			},
			{
				...
				name: 'deal',
				component: resolve => {
					require(['@/views/statistics/deal'], resolve)
				},
			},
			{
				...
				component: resolve => {
					require(['@/views/statistics/goods'], resolve)
				},
			},
			{
				...
				name: 'search',
				component: resolve => {
					require(['@/views/statistics/search'], resolve)
				},
			},
			{
				...
				name: 'refundDetail',
				component: resolve => {
					require(['@/views/order/refundDetail'], resolve)
				},
			},
			{
				...
				component: resolve => {
					require(['@/views/order/returnGoodsDetail'], resolve)
				},
			},
			{
			...
			},
			{
				...
				name: 'logistics',
				component: resolve => {
					require(['@/views/setup/logistics'], resolve)
				},
			},
			{
				...
				name: 'regional',
				component: resolve => {
					require(['@/views/setup/regional'], resolve)
				},
			},
			{
				...
				name: 'authority',
				component: resolve => {
					require(['@/views/authority/authority'], resolve)
				},
			},
